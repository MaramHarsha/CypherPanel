...
4. **The wire protocol contains no arbitrary-command verb.** The Phase 1 surface is enrollment + heartbeat/state only; the proto review explicitly checks that `work.*`/agent messages describe state, never shell strings. (§5.1)
