 ...
 */
import type { ListServerWorkloads200WorkloadsItem } from './listServerWorkloads200WorkloadsItem.ts';

export type ListServerWorkloads200 = {
  workloads: ListServerWorkloads200WorkloadsItem[];
};
