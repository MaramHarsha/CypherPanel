 ...
 */
import type { CreateAccessRequestRequestRequestedRole } from './createAccessRequestRequestRequestedRole.ts';

export interface CreateAccessRequestRequest {
  /** Must rank strictly above the caller's current role in this team. */
  requested_role: CreateAccessRequestRequestRequestedRole;
  /**
     * Why you need it — shown to the owners who decide.
     * @maxLength 500
     */
  message?: string;
}
