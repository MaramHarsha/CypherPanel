 ...
 */
import type { BackupRecordStatus } from './backupRecordStatus';
import type { BackupRecordFinishedAt } from './backupRecordFinishedAt';
...
export interface BackupRecord {
  ...
  detail?: string;
  started_at: string;
  finished_at?: BackupRecordFinishedAt;
  created_at: string;
}
