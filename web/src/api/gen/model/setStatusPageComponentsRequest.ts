 ...
 */
import type { SetStatusPageComponentsRequestComponentsItem } from './setStatusPageComponentsRequestComponentsItem.ts';

export interface SetStatusPageComponentsRequest {
  components: SetStatusPageComponentsRequestComponentsItem[];
}
