...
export type PanelUpgradePhase = typeof PanelUpgradePhase[keyof typeof PanelUpgradePhase];


export const PanelUpgradePhase = {
  preflight: 'preflight',
  waiting_for_quiesce: 'waiting_for_quiesce',
