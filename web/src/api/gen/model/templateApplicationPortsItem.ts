 ...
 */
import type { TemplateApplicationPortsItemProtocol } from './templateApplicationPortsItemProtocol.ts';

export type TemplateApplicationPortsItem = {
  host: number;
  container: number;
  protocol: TemplateApplicationPortsItemProtocol;
};
