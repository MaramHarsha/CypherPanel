 ...
 */
import type { PanelUpgradePhase } from './panelUpgradePhase.ts';

export interface PanelUpgrade {
  /** pup_… prefixed ID. */
  id: string;
  from_version: string;
  to_version: string;
  phase: PanelUpgradePhase;
  detail: string;
  /** Who asked. `external` marks a version change the panel observed rather than performed. */
  actor: string;
  rollback: boolean;
  snapshot_id?: string;
  started_at: string;
