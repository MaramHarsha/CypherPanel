...
export type TemplateApplicationHealthKind = typeof TemplateApplicationHealthKind[keyof typeof TemplateApplicationHealthKind];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TemplateApplicationHealthKind = {
  http: 'http',
  tcp: 'tcp',
  none: 'none',
  '': '',
