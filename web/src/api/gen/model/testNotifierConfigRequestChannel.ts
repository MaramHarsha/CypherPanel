...
export type TestNotifierConfigRequestChannel = typeof TestNotifierConfigRequestChannel[keyof typeof TestNotifierConfigRequestChannel];


export const TestNotifierConfigRequestChannel = {
  email: 'email',
  discord: 'discord',
  slack: 'slack',
  telegram: 'telegram',
