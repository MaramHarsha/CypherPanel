...
export type CreateNotifierRequestEventsItem = typeof CreateNotifierRequestEventsItem[keyof typeof CreateNotifierRequestEventsItem];


export const CreateNotifierRequestEventsItem = {
