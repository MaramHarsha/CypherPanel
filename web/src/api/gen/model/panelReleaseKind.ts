...
/**
 * The semver class of the delta from the running build — what a release badge shows, and how urgent the read is.
 */
export type PanelReleaseKind = typeof PanelReleaseKind[keyof typeof PanelReleaseKind];


export const PanelReleaseKind = {
  patch: 'patch',
  minor: 'minor',
  major: 'major',
} as const;
