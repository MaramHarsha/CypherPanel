 ...
 */
import type { CreateWebhookEndpointRequestEventsItem } from './createWebhookEndpointRequestEventsItem.ts';

export interface CreateWebhookEndpointRequest {
  /** http(s) receiver. */
  url: string;
  /**
     * webhook.ping is not subscribable — an endpoint always receives its own pings.
     * @minItems 1
     */
  events: CreateWebhookEndpointRequestEventsItem[];
  enabled?: boolean;
}
