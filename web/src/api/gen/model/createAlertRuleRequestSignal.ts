...
export type CreateAlertRuleRequestSignal = typeof CreateAlertRuleRequestSignal[keyof typeof CreateAlertRuleRequestSignal];


export const CreateAlertRuleRequestSignal = {
  cpu: 'cpu',
  memory: 'memory',
  disk: 'disk',
