 ...
 */
import type { PatchWebhookEndpointRequestEventsItem } from './patchWebhookEndpointRequestEventsItem.ts';

export interface PatchWebhookEndpointRequest {
  url?: string;
  events?: PatchWebhookEndpointRequestEventsItem[];
  enabled?: boolean;
}
