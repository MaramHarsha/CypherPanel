...
export interface AppAccess {
  ...
  /** Normalized CIDRs. Only these reach the app — for admin panels and internal tools. */
  ip_allowlist: string[];
  preview_password_enabled: boolean;
  /**
     * When the passphrase was last set. The passphrase itself is never returned; this is what answers "is this still the one I gave the client in March?".
     * @nullable
     */
