 ...
 */
import type { UpdateCheck } from './updateCheck.ts';
import type { UpdatePreflightMode } from './updatePreflightMode.ts';

export interface UpdatePreflight {
  version: string;
  mode: UpdatePreflightMode;
  /** False when any check refused. A warning never blocks. */
  can_proceed: boolean;
  needs_typed_confirm: boolean;
