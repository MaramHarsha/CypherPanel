 ...
 */
import type { OnboardingStepsItemName } from './onboardingStepsItemName.ts';

export type OnboardingStepsItem = {
  name: OnboardingStepsItemName;
  complete: boolean;
  /** What the step counts - enrolled servers, projects, succeeded deployments - so "1 server" reads as a fact rather than a tick. */
  count: number;
};
