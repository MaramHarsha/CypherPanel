 ...
 */
import type { TestNotifierConfigRequestChannel } from './testNotifierConfigRequestChannel.ts';
import type { TestNotifierConfigRequestConfig } from './testNotifierConfigRequestConfig.ts';

export interface TestNotifierConfigRequest {
  channel: TestNotifierConfigRequestChannel;
  /** The same channel-specific shape create takes. Never stored by this route. */
  config: TestNotifierConfigRequestConfig;
}
