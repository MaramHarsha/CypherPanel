 ...
 */
import type { PatchNotifierRequestConfig } from './patchNotifierRequestConfig.ts';
import type { PatchNotifierRequestEventsItem } from './patchNotifierRequestEventsItem.ts';

export interface PatchNotifierRequest {
  name?: string;
  events?: PatchNotifierRequestEventsItem[];
  enabled?: boolean;
  /** Supply to reseal the channel config wholesale; omit to keep the existing sealed value. */
  config?: PatchNotifierRequestConfig;
}
