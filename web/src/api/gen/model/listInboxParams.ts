...
/**
 * Pass true to return only unread items. Filtered-to-zero is a distinct state from an empty inbox.
 */
unread?: boolean;
/**
 * Page size; caps at 100.
 * @minimum 1
 * @maximum 100
 */
limit?: number;
/**
 * Seek cursor: return items strictly older than this item id. Keyset, not offset — a feed gains rows at the head while you page it.
 */
before?: string;
};
