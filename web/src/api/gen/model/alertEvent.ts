...
export interface AlertEvent {
  ...
  /** The worst bucket of the episode — the number an operator wants once they know the alert is real. */
  peak_value: number;
  /** False when the flap guard held it. The episode still happened and is still counted. */
  delivered: boolean;
}
