 ...
 */
import type { AppAccess } from './appAccess.ts';

export type PreviewPasswordResult = AppAccess & {
  /** Readable exactly once, in this response. Absent when the gate was cleared. */
  passphrase?: string;
};
