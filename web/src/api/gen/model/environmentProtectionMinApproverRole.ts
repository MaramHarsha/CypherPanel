 ...
 */
export type EnvironmentProtectionMinApproverRole = typeof EnvironmentProtectionMinApproverRole[keyof typeof EnvironmentProtectionMinApproverRole];


export const EnvironmentProtectionMinApproverRole = {
  member: 'member',
  admin: 'admin',
  owner: 'owner',
} as const;
