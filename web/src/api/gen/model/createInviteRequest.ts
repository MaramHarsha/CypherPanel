 ...
 */
import type { CreateInviteRequestRole } from './createInviteRequestRole.ts';

export interface CreateInviteRequest {
  email: string;
  /** May not exceed the caller's own rank; inviting an owner needs team owner. Checked here rather than at acceptance, because the person accepting has no rank of their own. */
