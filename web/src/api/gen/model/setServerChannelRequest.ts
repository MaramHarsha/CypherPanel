 ...
 */
import type { SetServerChannelRequestChannel } from './setServerChannelRequestChannel.ts';

export interface SetServerChannelRequest {
  channel: SetServerChannelRequestChannel;
}
