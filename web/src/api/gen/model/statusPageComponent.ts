 ...
 */
import type { StatusPageComponentResourceKind } from './statusPageComponentResourceKind.ts';

export interface StatusPageComponent {
  /** spc_… prefixed ID. */
  id: string;
  resource_kind: StatusPageComponentResourceKind;
  resource_id: string;
  /** The ONLY name that becomes public. The resource's own name never leaves the panel. */
  label: string;
  position: number;
}
