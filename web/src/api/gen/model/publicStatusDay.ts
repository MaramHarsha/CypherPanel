 ...
 */
import type { PublicStatusDayState } from './publicStatusDayState.ts';

export interface PublicStatusDay {
  /** The UTC day */
  date: string;
  state: PublicStatusDayState;
  down_seconds: number;
  degraded_seconds: number;
  /** Seconds observed and not unknown. Zero means the day is grey and excluded from the percentage. */
