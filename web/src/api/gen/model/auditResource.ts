...
export interface AuditResource {
  /** The glossary noun acted on — `user`, `session`, `api_token`, `team`, `server`, `deploy_key`, `project`, `environment`, `application`, `database`, `deployment`, `backup_target`, `backup_schedule`, `shared_variable`, `notifier`, `webhook_endpoint`, `panel`. Not a table name: an env-var change names the APPLICATION and a membership change names the TEAM, because that is the timeline they are read from. */
  kind: string;
  id: string;
  /** The name at the time. Empty when the action had no name to snapshot. */
  name: string;
}
