 ...
 */
import type { UpdateCheckKey } from './updateCheckKey.ts';
import type { UpdateCheckStatus } from './updateCheckStatus.ts';

export interface UpdateCheck {
  key: UpdateCheckKey;
  status: UpdateCheckStatus;
  text: string;
  /** What to do about it. A refusal with no remedy is a dead end. */
  remedy?: string;
}
