 ...
 */
import type { SetStatusPageComponentsRequestComponentsItemResourceKind } from './setStatusPageComponentsRequestComponentsItemResourceKind.ts';

export type SetStatusPageComponentsRequestComponentsItem = {
  resource_kind: SetStatusPageComponentsRequestComponentsItemResourceKind;
  resource_id: string;
  label: string;
};
