...
export interface ArmPlaneDRRequest {
  target_id: string;
  path_prefix?: string;
  schedule?: string;
  retention_count?: number;
  /** Mint the pair here. The private half comes back once and never again. */
  generate?: boolean;
  /** An age public key you already hold the private half of. */
  recipient?: string;
}
