 ...
 */
import type { ListServerWorkloads200WorkloadsItemKind } from './listServerWorkloads200WorkloadsItemKind.ts';

export type ListServerWorkloads200WorkloadsItem = {
  id: string;
  kind: ListServerWorkloads200WorkloadsItemKind;
  name: string;
  project_id: string;
  project_name: string;
  status: string;
