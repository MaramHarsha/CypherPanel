 ...
 */
import type { FreezeWindowInput } from './freezeWindowInput.ts';
import type { SetProtectionRequestMinApproverRole } from './setProtectionRequestMinApproverRole.ts';

export interface SetProtectionRequest {
  require_approval: boolean;
  min_approver_role: SetProtectionRequestMinApproverRole;
  freeze_enabled: boolean;
  /**
     * The complete window list; it replaces whatever was there.
     * @maxItems 8
     */
  windows: FreezeWindowInput[];
}
