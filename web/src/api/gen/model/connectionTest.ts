...
export interface ConnectionTest {
  /** Whether the far end accepted the message. */
  ok: boolean;
  /** What the far end said, verbatim on failure. "connection refused" is the whole answer, and paraphrasing it makes an operator guess. */
  detail: string;
}
