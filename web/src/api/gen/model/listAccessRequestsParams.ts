 ...
 */
import type { ListAccessRequestsState } from './listAccessRequestsState.ts';

export type ListAccessRequestsParams = {
/**
 * `pending` (the default) is the owners' queue; `all` adds the decided ones.
 */
state?: ListAccessRequestsState;
};
