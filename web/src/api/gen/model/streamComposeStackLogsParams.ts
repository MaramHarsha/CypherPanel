...
export type StreamComposeStackLogsParams = {
/**
 * Where the replay starts — a Go duration (`15m`) or an RFC 3339 instant. Omitted replays everything retained, then tails.
 */
since?: string;
};
