 ...
 */
import type { TemplateApplicationHealthKind } from './templateApplicationHealthKind.ts';

export type TemplateApplicationHealth = {
  kind: TemplateApplicationHealthKind;
  path: string;
};
