 ...
 */
import type { ResourceQuotaScopeKind } from './resourceQuotaScopeKind.ts';

export interface ResourceQuota {
  /** quo_… prefixed ID. */
  id: string;
  scope_kind: ResourceQuotaScopeKind;
  scope_id: string;
  /**
     * Null means uncapped. Metered against DECLARED memory, not observed.
     * @nullable
     */
