 ...
 */
import type { GitHubInstallation } from './gitHubInstallation.ts';

export interface GitHubApp {
  configured: boolean;
  app_id?: number;
  slug?: string;
  /** Where to send an operator to install the App, built from the slug so nobody is told to "go and find your App". */
  install_url?: string;
  updated_at?: string;
