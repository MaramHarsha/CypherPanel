...
export interface SubsystemHealth {
  /** The agent's own stable name for the failing part — `proxy`, `updater`. These are subsystems that fail in a LOOP rather than crashing, which is exactly why they need reporting. */
  subsystem: string;
  /** What the subsystem said went wrong. A diagnosis, never a value — nothing that unseals a secret reports through here. */
  message: string;
}
