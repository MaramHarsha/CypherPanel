 ...
 */
export type CreateAlertRuleRequestThresholdUnit = typeof CreateAlertRuleRequestThresholdUnit[keyof typeof CreateAlertRuleRequestThresholdUnit];


export const CreateAlertRuleRequestThresholdUnit = {
  percent: 'percent',
  bytes: 'bytes',
