...
export type AccessRequestRequestedRole = typeof AccessRequestRequestedRole[keyof typeof AccessRequestRequestedRole];


export const AccessRequestRequestedRole = {
  member: 'member',
  admin: 'admin',
  owner: 'owner',
} as const;
