...
export interface ResourceMetricPoint {
  at: string;
  /** Derived from the bucket's accumulator over its covered time — never a stored mean. */
  cpu_percent: number;
  /** The highest single sample. Without it a 5-minute mean hides exactly the spike you opened the page to find. */
  cpu_percent_peak: number;
  memory_bytes: number;
  memory_bytes_peak: number;
  /** How much of the bucket was observed. Draw a partial bucket as partial, not as a dip. */
