...
export type DomainCheckVerdict = typeof DomainCheckVerdict[keyof typeof DomainCheckVerdict];


export const DomainCheckVerdict = {
  ok: 'ok',
  no_domain: 'no_domain',
  no_dns: 'no_dns',
  unreachable: 'unreachable',
  served_by_other: 'served_by_other',
} as const;
