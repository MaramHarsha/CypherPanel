...
export interface SetAgentChannelRequest {
  /** Empty clears the instruction. */
  version: string;
  /** Empty derives the prefix from the version, which is every fleet using the project's own releases. */
