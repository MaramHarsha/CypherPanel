...
export type SetServerChannelRequestChannel = typeof SetServerChannelRequestChannel[keyof typeof SetServerChannelRequestChannel];


export const SetServerChannelRequestChannel = {
  stable: 'stable',
  canary: 'canary',
} as const;
