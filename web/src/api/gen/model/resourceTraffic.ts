 ...
 */
import type { TrafficPath } from './trafficPath.ts';
import type { TrafficPoint } from './trafficPoint.ts';
import type { TrafficSummary } from './trafficSummary.ts';

export interface ResourceTraffic {
  resolution: string;
  /** @nullable */
  as_of?: string | null;
  /** False when request analytics is off */
  collecting: boolean;
  points: TrafficPoint[];
  paths: TrafficPath[];
