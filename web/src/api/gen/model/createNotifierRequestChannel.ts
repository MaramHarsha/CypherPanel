...
export type CreateNotifierRequestChannel = typeof CreateNotifierRequestChannel[keyof typeof CreateNotifierRequestChannel];


export const CreateNotifierRequestChannel = {
  email: 'email',
  discord: 'discord',
  slack: 'slack',
  telegram: 'telegram',
