...
export type CreateAlertRuleRequestTargetKind = typeof CreateAlertRuleRequestTargetKind[keyof typeof CreateAlertRuleRequestTargetKind];


export const CreateAlertRuleRequestTargetKind = {
  server: 'server',
