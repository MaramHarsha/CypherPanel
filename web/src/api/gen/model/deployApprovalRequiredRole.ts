 ...
 */
export type DeployApprovalRequiredRole = typeof DeployApprovalRequiredRole[keyof typeof DeployApprovalRequiredRole];


export const DeployApprovalRequiredRole = {
  member: 'member',
  admin: 'admin',
  owner: 'owner',
} as const;
