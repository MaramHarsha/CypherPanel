 ...
 */
import type { ChooseAccountErrorAccountsItem } from './chooseAccountErrorAccountsItem.ts';

export interface ChooseAccountError {
  error: string;
  /** Present only when the token reaches several accounts; the choices to pick from. */
  accounts?: ChooseAccountErrorAccountsItem[];
}
