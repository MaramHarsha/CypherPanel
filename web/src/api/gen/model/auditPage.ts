...
export interface AuditPage {
  events: AuditEvent[];
  /** Pass as `before` for the following page. Empty at the end of the log. A full page always returns a cursor, so the last page of an exactly-divisible log costs one extra request that comes back empty. */
  next_before: string;
}
