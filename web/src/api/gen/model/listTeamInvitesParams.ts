 ...
 */
import type { ListTeamInvitesState } from './listTeamInvitesState.ts';

export type ListTeamInvitesParams = {
/**
 * `pending` (the default) lists only invitations that can still be accepted; `all` adds the accepted, revoked and expired ones.
 */
state?: ListTeamInvitesState;
};
