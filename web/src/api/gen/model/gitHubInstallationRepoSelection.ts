...
export type GitHubInstallationRepoSelection = typeof GitHubInstallationRepoSelection[keyof typeof GitHubInstallationRepoSelection];


export const GitHubInstallationRepoSelection = {
  all: 'all',
  selected: 'selected',
} as const;
