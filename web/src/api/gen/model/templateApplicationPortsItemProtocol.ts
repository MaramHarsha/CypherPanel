...
export type TemplateApplicationPortsItemProtocol = typeof TemplateApplicationPortsItemProtocol[keyof typeof TemplateApplicationPortsItemProtocol];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TemplateApplicationPortsItemProtocol = {
  tcp: 'tcp',
  udp: 'udp',
  '': '',
} as const;
