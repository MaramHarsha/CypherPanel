...
export type SetProtectionRequestMinApproverRole = typeof SetProtectionRequestMinApproverRole[keyof typeof SetProtectionRequestMinApproverRole];


export const SetProtectionRequestMinApproverRole = {
  member: 'member',
  admin: 'admin',
  owner: 'owner',
} as const;
