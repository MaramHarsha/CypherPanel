...
export interface MailDomain {
  ...
  domain: string;
  /**
     * Null means asked but not confirmed — pending, not done.
     * @nullable
     */
  records_written_at?: string | null;
  /** Which record did not land, so the operator can fix that one rather than starting over. */
  last_error: string;
}
