 ...
 */
import type { ListDeployApprovalsState } from './listDeployApprovalsState.ts';

export type ListDeployApprovalsParams = {
/**
 * Filter by decision state. Defaults to `pending`; pass `all` for every state.
 */
state?: ListDeployApprovalsState;
};
