...
export interface PatchSharedVariableRequest {
  /**
     * Replaces the sealed value. Always bumps updated_at, even when the plaintext is unchanged, which marks every referencing application "redeploy to apply".
     * @maxLength 32768
     */
  value: string;
}
