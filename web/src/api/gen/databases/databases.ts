...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListDatabasesQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listDatabases>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatabaseQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDatabase>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const updateDatabase = async (id: string,
  ...
  return apiFetch<Database>(getUpdateDatabaseUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patchDatabaseRequest)
  }
);}
...
export const useStopDatabase = <TError = UnauthorizedResponse | ForbiddenResponse | NotFoundResponse,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getStopDatabaseMutationOptions(options), queryClient);
    }
...
export const useStartDatabase = <TError = UnauthorizedResponse | ForbiddenResponse | NotFoundResponse,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getStartDatabaseMutationOptions(options), queryClient);
    }
...
export const useResetDatabasePassword = <TError = UnauthorizedResponse | ForbiddenResponse | NotFoundResponse | Error,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getResetDatabasePasswordMutationOptions(options), queryClient);
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatabaseConnectionInfoQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDatabaseConnectionInfo>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
